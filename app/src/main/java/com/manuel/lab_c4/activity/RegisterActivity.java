...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText tipoInput,correoInput, descripcionInput;
    ...
    public void callRegister(View view) {
        ...
        if (correo.isEmpty() || tipo.isEmpty()) {
            Toast.makeText(this, "Correo y Tipo son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createSolicitud(tipo,correo,descripcion);
        } else {
            ...
            RequestBody decripcionPart = RequestBody.create(MultipartBody.FORM, descripcion);

            call = service.createSolicitudWithImage(tipoPart, correoPart, decripcionPart, imagenPart);
        }
